# FM - Huddle Landing Page Solution - Fraser Jubb

This is a solution to [this challenge on Frontend Mentor](https://www.frontendmentor.io/challenges/huddle-landing-page-with-a-single-introductory-section-B_2Wvxgi0).
...
1. In this project, I realized that working with multiple monitors when developing the CSS code can get a bit problematic when switching the browser between them as it will look different on each size. This made the process a bit of a headache and made it longer than it should have been. In future project, I will decide a screen and stick to it until media queries.
